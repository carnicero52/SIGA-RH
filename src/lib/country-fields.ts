/**
 * Country-specific legal identification fields and timezone config.
 */
...
export const COUNTRY_CONFIGS: Record<string, CountryConfig> = {
  Venezuela: {
    ...
    fields: {
      id1: { key: 'curp', label: 'Cédula de Identidad', placeholder: 'V-12345678',  maxLength: 12, hint: 'Cédula venezolana (V- o E-)' },
  ...
  Chile: {
    ...
    fields: {
      id1: { key: 'curp', label: 'RUT', placeholder: '12.345.678-9', maxLength: 12, hint: 'Rol Único Tributario' },
  ...
  'República Dominicana': {
    name: 'República Dominicana', flag: '🇩🇴', timezone: 'America/Santo_Domingo',
    fields: {
  ...
  Panamá: {
    name: 'Panamá', flag: '🇵🇦', timezone: 'America/Panama',
    fields: {
  ...
  'Estados Unidos': {
    ...
    fields: {
      ...
      ss:  { key: 'nss', label: 'SSN',          placeholder: '123-45-6789', maxLength: 11, hint: 'Social Security Number' },
    },
  },
  Otro: {
    name: 'Otro', flag: '🌎', timezone: 'UTC',
    fields: {
